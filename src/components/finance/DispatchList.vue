<template>
  <div class="min1500">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>报销单</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card>
      <!-- <el-row :gutter="20"> -->
      <!-- ref作用？？ -->
            ...
            <el-table-column label="操作" width="260px">
             <template slot-scope="scope">
                ...
                <el-button
                  type="danger"
                  icon="el-icon-delete"
                  @click="deletebumen(scope.row.reimbursementBxnumbers)"
                  size="mini"
                :disabled="scope.row.reimbursementStatus==1 || scope.row.reimbursementStatus==3 ||scope.row.reimbursementStatus==5">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
      <el-pagination
