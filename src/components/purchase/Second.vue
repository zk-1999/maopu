  ...
  <div class="min1500">
      ...
      <el-form :inline="true" class="demo-form-inline search" :model="chaOrderFrom" ref="chaOrderFrom">
        <el-row :gutter="20" class="row">
          <el-col :span="24">
            ...
            <el-form-item prop="porderProducer" >
                            <el-input placeholder="请输入人员" v-model="chaOrderFrom.porderProducer" class="input-with-select" style="width: 250px" >
                                <el-select v-model="chaOrderFrom.personChooose" slot="prepend" placeholder="请选择"  style="width: 110px">
                                <el-option value="0" label="制单人员"></el-option>
                                <el-option value="1" label="审核人员"></el-option>
                                </el-select>
                            </el-input>
                        </el-form-item>
            <el-form-item  prop="porderReviewtime">
                            <el-select v-model="chaOrderFrom.personChooose" placeholder="请选择"  style="width: 110px">
                                <el-option value="0" label="制单时间"></el-option>
                                <el-option value="1" label="审核时间"></el-option>
                                </el-select>
              <el-date-picker
                v-model="chaOrderFrom.porderTime"
                type="date"
                format="yyyy年MM月dd日"
    ...
    >
      ...
      >
        ...
        <hr />
        <el-form-item label="审核人" class="w500">
          <el-input
            placeholder="请输入内容"
            v-model="editOrderForm.porderReviewman"
          ></el-input>
        </el-form-item>
        <el-form-item label="审核结果" class="w500">
            <el-radio v-model="editOrderForm.porderState" label="3">通过</el-radio>
            <el-radio v-model="editOrderForm.porderState" label="2">驳回</el-radio>
        </el-form-item>
        <el-form-item label="审核备注" class="w500">
          <el-input
            type="textarea"
            placeholder="请输入内容"
  ...
  data() {
    ...
    //   },
      ...
      editOrderForm: {
        ...
        pageSize: 10, //每页显示的记录数
          porderReviewman: "",//审核人
          porderState: "",//审核结果，改变订单状态
          porderReviewtime: "",//审核时间
      ...
      chaOrderFrom: {
        ...
        porderProducer: "",
        porderState: "",
        personChooose:"",//人员类别选择
        porderTime: "",
        porderReviewtime:"",//订单初审时间
        pageCode: 1, //当前页
        pageSize: 10 //每页显示的记录数
      },
      chaSupplierForm: {
