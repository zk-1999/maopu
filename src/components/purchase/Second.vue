    ...
    >
      ...
      >
        ...
        <el-form-item label="审核结果" prop="porderPalnmoney">
          <el-input v-if="checkOrderForm.porderState == 3" value="通过" :disabled="true">></el-input>
          <el-input v-if="checkOrderForm.porderState == 2" value="驳回" :disabled="true">></el-input>
        </el-form-item>
        <br />
        <el-form-item label="备注" prop="porderReviewexplain">
          <el-input type="textarea" v-model="checkOrderForm.porderReviewexplain" :disabled="true">></el-input>
        </el-form-item>
        ...
        <el-form-item label="备注" prop="porderReviewedexplain">
          <el-input type="textarea" v-model="checkOrderForm.porderReviewedexplain"></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    async checkOrder(porderCode) {
      ...
      // 使页面正确显示
      if (this.checkOrderForm.porderState == 3) {
        this.checkOrderForm.porderState = "3";
      }
      ...
      // this.checkOrderForm.porderReviewedman = "";
      this.getCookie();
