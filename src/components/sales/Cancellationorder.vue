<template>
  ...
  <div class="fenge1">合计信息</div>
    ...
    <el-button type="primary" @click="addOrdermanagementVisible1 = true">新增预收款单</el-button>
    ...
    <el-dialog :title=" '新增预收款单' " :visible.sync="addOrdermanagementVisible1" width="55%" :before-close="handleClose">
