<template>
  <div class="min1500">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>销售订单-初审</el-breadcrumb-item>
    </el-breadcrumb>
<el-card>
      <el-form
        :inline="true"
      ...
      >
        ...
        <el-table-column prop="sorderStatus" label="订单状态" align="center">
          <!-- <template slot-scope="scope">
            ...
            <el-tag type="danger" v-if="scope.row.sorderStatus=='1'">待审核</el-tag>
        ...
        <el-table-column label="操作" width="150px" style="text-align:center">
          <template slot-scope="scope">
             ...
             <el-button @click="showEditOrdermanagement(scope.row.sorderCode,true,1)" type="primary" size="small" :disabled="scope.row.sorderStatus!=1" >审 批</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
  ...
  methods: {
   ...
   async shengchanshangping(){
    ...
    guoqudangqianshijian(){
      ...
      var d = date.getDate()
      this.editOrdermanagementForm.sorderChushentime=`${y}-${mm}-${d}`
    },
