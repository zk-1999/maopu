<template>
  <div class="min1500">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>销售订单审核</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card>
      <!-- ref作用？？ -->
      <el-form
      ...
      >
        ...
        <el-table-column label="订单号">
          <template slot-scope="scope"><a @click.prevent="auditing = true">{{ scope.row.orderNum }}</a></template>
        </el-table-column>
        ...
        <el-table-column label="操作">
          <el-button type="primary" size="small" @click="auditing = true">提 审</el-button>
        </el-table-column>
      </el-table>
      <!-- 表格操作按钮 -->
    ...
    <el-dialog title="销售订单审核" :visible.sync="auditing" width="60%" :before-close="handleClose">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        ...
        <el-table :data="t" style="width: 100%">
          ...
          <el-table-column label="审核描述"></el-table-column>
        </el-table>
        <hr />
