  ...
  <div class="min1500">
    ...
    <el-card>
      ...
      >
        <!-- 订单号 -->
        <!-- <el-form-item>
          <el-select v-model="salesOrdermanagementForm.value0" class="hu2">
            <el-option
              v-for="item in salesOrdermanagementForm.orderNoOptions"
              :key="item.value"
              :label="item.label"
              :value="item.value"
            ></el-option>
          ...
          <el-input v-model="salesOrdermanagementForm.orderNo" class="hu"></el-input>
        </el-form-item>-->
        ...
        <el-form-item label="订单状态" class="mar">
          <el-select value="0" class="hu">
            <!-- <el-option
              ...
              :value="item.value"
            ></el-option> -->
            <el-option value="0">生产中</el-option>
            <el-option value="1">待发货</el-option>
            <el-option value="2">部分发货</el-option>
      ...
      <!-- 4个按钮 -->
      <el-button type="primary" size="small">生成折消单</el-button>
      <!-- <el-button type="success">成功按钮</el-button> -->
      <el-button type="info" size="small">发货</el-button>
      <el-button type="info" size="small">下载订单</el-button>
      ...
      >
        ...
        <el-table-column  label="订单号">
          <template slot-scope="scope"><a @click.prevent="order=true">{{ scope.row.orderNum }}</a></template>
        </el-table-column>
        ...
        <el-tab-pane label="基础信息" name="first">
          <el-form title="订单" inline="true">
            ...
            <el-table :data="t" style="width: 100%">
              ...
              <el-table-column label="收款单号"></el-table-column>
              <el-table-column label="操作时间"></el-table-column>
              <el-table-column label="备注"></el-table-column>
            </el-table>
            <el-form-item label="合计" style="margin-left:600px; margin-top:20px;">
              <el-input disabled class="hu"></el-input>
            </el-form-item>
            <!-- 收货信息 -->
            <hr />
