  ...
  <div class="min1500">
    ...
    <el-card>
      ...
      <el-form :inline="true" class="demo-form-inline" :model="salesOrdermanagementForm">
        ...
        <!-- 下架状态 -->
        <el-form-item label="下架状态" class="mar">
        ...
        <!-- 采购退货单号 -->
        <el-form-item label="采购退货单号" class="mar">
          <el-input v-model="salesOrdermanagementForm.phoneNumber" class="hu"></el-input>
        </el-form-item>
      ...
      >
        ...
        <el-table-column prop label="采购退货单号"></el-table-column>
        <el-table-column prop label="仓库名称"></el-table-column>
        <el-table-column prop label="制单人"></el-table-column>
        <el-table-column prop label="出库类型"></el-table-column>
        <el-table-column prop label="出库时间"></el-table-column>
        ...
        <el-table-column prop label="下架状态"></el-table-column>
        <el-table-column prop label="下架时间"></el-table-column>
    ...
    <el-dialog :title=" '新增出库单' " :visible.sync="addOrder" width="60%" :before-close="handleClose">
      <!-- 新增出库单表格 -->
