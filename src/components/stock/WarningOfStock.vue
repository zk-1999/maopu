  ...
  <div class="min1500">
    ...
    <el-card>
      ...
      <el-form :inline="true" class="demo-form-inline" :model="salesOrdermanagementForm">
        ...
        <!-- 选择类型 -->
        <el-form-item label="选择类型" class="mar">
          <el-select v-model="value" placeholder="警戒库存" class="hu">
            <el-option
          ...
          <el-select v-model="value" placeholder="大于" class="hu">
            <el-option
              v-for="item in options"
              :key="item.value"
              :label="item.label"
          ...
          <el-input v-model="input" class="hu"></el-input>
        </el-form-item>
      ...
      >
        ...
        <el-table-column prop label="警戒库存"></el-table-column>
      </el-table>
